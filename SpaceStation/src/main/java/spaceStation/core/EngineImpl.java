...
public class EngineImpl implements Engine {
    ...
    public void run() {
        while (true) {
            ...
            } catch (NullPointerException | IllegalArgumentException | IOException | NoSuchFieldException e) {
                result = e.getMessage();
            }
    ...
    private String processInput() throws IOException, NoSuchFieldException {
    ...
    private String retireAstronaut(String[] data) throws NoSuchFieldException {
